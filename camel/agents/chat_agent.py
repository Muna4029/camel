...
class ChatAgent(BaseAgent):
    ...
    def _generate_system_message_for_output_language(
        ...
        if self._original_system_message is not None:
            original_content = self._original_system_message.content or ""
            content = original_content + language_prompt
    ...
    def astep(
        ...
        input_message: BaseMessage | str,
        response_format: type[BaseModel] | None = None,
    ) -> Awaitable[ChatAgentResponse] | AsyncStreamingChatAgentResponse:
